...
pub trait CreateEntity<T: Builder>: Sized {
    ...
    fn create_player(self, id: ObjectId, cls: Class, pos: Pos, lives: Lives, ori: Ori) -> Entity {
        self.builder()
            .with(Player)
    ...
    fn create_bullet(self, id: ObjectId, cls: Class, pos: Pos, dmg: Damage, ori: Ori) -> Entity {
        self.builder()
            .with(Bullet)
